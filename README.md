...
| PNC Models | RMSE | Max Error| PPG Models | RMSE | Max Error |
|------------|------|----------|------------|------|-----------|
|ARIMA (1,0,0)| 6.6788 |10.7829| ARIMA (2,0,0) | 4.7629 | 10.0517 |
|SARIMA (1,0,0), (3,1,0,12)| 6.3673 | 10.6739| SARIMA (2,0,0), (4,1,0,12) | 5.9812 | 12.7273 | 
|SARIMAX (1,0,0), (3,1,0,12)|6.3249 | 10.8575| SARIMAX (2,0,0), (4,1,0,12) | 6.0651 | 13.2337 |
|RF| 6.8906 | 11.7453 | RF | 4.9672 | 11.3359 | 
|RF with Ex| 6.5191 | 10.0036 | RF | 4.8565 | 10.4117 | 
|XGBoost | 6.8543 | 11.1830 | XGBoost | 4.8892 | 10.8080 | 
|XGBoost with Ex | 6.5239 | 9.7682 | XGBoost with Ex | 4.7554 | 9.7492 |
|SARIMAX with XGB Residuals | 6.3010 | 10.5845 | SARIMAX with XGB Residuals | 4.5666 | 9.5830 |
|LSTM | 5.7627 | **9.5701** | LSTM | 4.2794 | 10.0447 | 
|LSTMX | **5.2856** | 9.7363 | LSTMX | 4.3353 | 9.1738 |
